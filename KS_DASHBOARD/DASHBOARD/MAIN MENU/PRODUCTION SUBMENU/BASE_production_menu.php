...
<html>
    <head>
        ...
        <script> function if_undefined(number){if(typeof number === 'undefined'){return 0;}else{return number;}}</script>
            ...
            $(document).ready(function()
            {
                $.getJSON('../../PRODUCTION/CACHED/group_steps_template.json', function(steps_template)
                {
                    $.getJSON('../../PRODUCTION/CACHED/step_capacity.json', function(capacity)
                    {
                        ...
                        {
                            console.log(Number(if_undefined(demand[steps_template[2].steps[3]])));
                            ...
                            const dataSource = {
                                ...
                                dataset: [
                                    ...
                                    data: [
                                        {
                                        value:  Number(if_undefined(demand[steps_template[1].steps[1]])) + 
                                                Number(if_undefined(demand[steps_template[1].steps[2]])) + 
                                                Number(if_undefined(demand[steps_template[1].steps[3]])) + 
                                                Number(if_undefined(demand[steps_template[1].steps[4]])) + 
                                                Number(if_undefined(demand[steps_template[1].steps[5]])) + 
                                                Number(if_undefined(demand[steps_template[1].steps[6]])) + 
                                                Number(if_undefined(demand[steps_template[1].steps[7]])) + 
                                                Number(if_undefined(demand[steps_template[1].steps[8]])),
                                        },
                                        {
                                        value:  Number(if_undefined(demand[steps_template[2].steps[2]])) + 
                                                Number(if_undefined(demand[steps_template[2].steps[2]])) + 
                                                Number(if_undefined(demand[steps_template[2].steps[3]])) + 
                                                Number(if_undefined(demand[steps_template[2].steps[4]])) + 
                                                Number(if_undefined(demand[steps_template[2].steps[5]])) + 
                                                Number(if_undefined(demand[steps_template[2].steps[6]])) + 
                                                Number(if_undefined(demand[steps_template[2].steps[7]])) + 
                                                Number(if_undefined(demand[steps_template[2].steps[8]])),
                                        },
                                        {
                                        value:  Number(if_undefined(demand[steps_template[3].steps[1]])) + 
                                                Number(if_undefined(demand[steps_template[3].steps[2]])) + 
                                                Number(if_undefined(demand[steps_template[3].steps[3]])) + 
                                                Number(if_undefined(demand[steps_template[3].steps[4]])) + 
                                                Number(if_undefined(demand[steps_template[3].steps[5]])) + 
                                                Number(if_undefined(demand[steps_template[3].steps[6]])) + 
                                                Number(if_undefined(demand[steps_template[3].steps[7]])) + 
                                                Number(if_undefined(demand[steps_template[3].steps[8]])),
                                        },
                                        {
                                        value:  Number(if_undefined(demand[steps_template[4].steps[1]])) + 
                                                Number(if_undefined(demand[steps_template[4].steps[2]])) + 
                                                Number(if_undefined(demand[steps_template[4].steps[3]])) + 
                                                Number(if_undefined(demand[steps_template[4].steps[4]])) + 
                                                Number(if_undefined(demand[steps_template[4].steps[5]])) + 
                                                Number(if_undefined(demand[steps_template[4].steps[6]])) + 
                                                Number(if_undefined(demand[steps_template[4].steps[7]])) + 
                                                Number(if_undefined(demand[steps_template[4].steps[8]])),
                                        },
                                        {
                                        value:  Number(if_undefined(demand[steps_template[5].steps[1]])) + 
                                                Number(if_undefined(demand[steps_template[5].steps[2]])) + 
                                                Number(if_undefined(demand[steps_template[5].steps[3]])) + 
                                                Number(if_undefined(demand[steps_template[5].steps[4]])) + 
                                                Number(if_undefined(demand[steps_template[5].steps[5]])) + 
                                                Number(if_undefined(demand[steps_template[5].steps[6]])) + 
                                                Number(if_undefined(demand[steps_template[5].steps[7]])) + 
                                                Number(if_undefined(demand[steps_template[5].steps[8]])),
                                        },
                                        {
                                        value:  Number(if_undefined(demand[steps_template[6].steps[1]])) + 
                                                Number(if_undefined(demand[steps_template[6].steps[2]])) + 
                                                Number(if_undefined(demand[steps_template[6].steps[3]])) + 
                                                Number(if_undefined(demand[steps_template[6].steps[4]])) + 
                                                Number(if_undefined(demand[steps_template[6].steps[5]])) + 
                                                Number(if_undefined(demand[steps_template[6].steps[6]])) + 
                                                Number(if_undefined(demand[steps_template[6].steps[7]])) + 
                                                Number(if_undefined(demand[steps_template[6].steps[8]])),
                                        }
                                    ]
                                    },
                                    {
                                    ...
                                    data: [
                                        {
                                        value:  Number(if_undefined(capacity[steps_template[1].steps[1]])) + 
                                                Number(if_undefined(capacity[steps_template[1].steps[2]])) + 
                                                Number(if_undefined(capacity[steps_template[1].steps[3]])) + 
                                                Number(if_undefined(capacity[steps_template[1].steps[4]])) + 
                                                Number(if_undefined(capacity[steps_template[1].steps[5]])) + 
                                                Number(if_undefined(capacity[steps_template[1].steps[6]])) + 
                                                Number(if_undefined(capacity[steps_template[1].steps[7]])) + 
                                                Number(if_undefined(capacity[steps_template[1].steps[8]])),
                                        },
                                        {
                                        value:  Number(if_undefined(capacity[steps_template[2].steps[2]])) + 
                                                Number(if_undefined(capacity[steps_template[2].steps[2]])) + 
                                                Number(if_undefined(capacity[steps_template[2].steps[3]])) + 
                                                Number(if_undefined(capacity[steps_template[2].steps[4]])) + 
                                                Number(if_undefined(capacity[steps_template[2].steps[5]])) + 
                                                Number(if_undefined(capacity[steps_template[2].steps[6]])) + 
                                                Number(if_undefined(capacity[steps_template[2].steps[7]])) + 
                                                Number(if_undefined(capacity[steps_template[2].steps[8]])),
                                        },
                                        {
                                        value:  Number(if_undefined(capacity[steps_template[3].steps[1]])) + 
                                                Number(if_undefined(capacity[steps_template[3].steps[2]])) + 
                                                Number(if_undefined(capacity[steps_template[3].steps[3]])) + 
                                                Number(if_undefined(capacity[steps_template[3].steps[4]])) + 
                                                Number(if_undefined(capacity[steps_template[3].steps[5]])) + 
                                                Number(if_undefined(capacity[steps_template[3].steps[6]])) + 
                                                Number(if_undefined(capacity[steps_template[3].steps[7]])) + 
                                                Number(if_undefined(capacity[steps_template[3].steps[8]])),
                                        },
                                        {
                                        value:  Number(if_undefined(capacity[steps_template[4].steps[1]])) + 
                                                Number(if_undefined(capacity[steps_template[4].steps[2]])) + 
                                                Number(if_undefined(capacity[steps_template[4].steps[3]])) + 
                                                Number(if_undefined(capacity[steps_template[4].steps[4]])) + 
                                                Number(if_undefined(capacity[steps_template[4].steps[5]])) + 
                                                Number(if_undefined(capacity[steps_template[4].steps[6]])) + 
                                                Number(if_undefined(capacity[steps_template[4].steps[7]])) + 
                                                Number(if_undefined(capacity[steps_template[4].steps[8]])),
                                        },
                                        {
                                        value:  Number(if_undefined(capacity[steps_template[5].steps[1]])) + 
                                                Number(if_undefined(capacity[steps_template[5].steps[2]])) + 
                                                Number(if_undefined(capacity[steps_template[5].steps[3]])) + 
                                                Number(if_undefined(capacity[steps_template[5].steps[4]])) + 
                                                Number(if_undefined(capacity[steps_template[5].steps[5]])) + 
                                                Number(if_undefined(capacity[steps_template[5].steps[6]])) + 
                                                Number(if_undefined(capacity[steps_template[5].steps[7]])) + 
                                                Number(if_undefined(capacity[steps_template[5].steps[8]])),
                                        },
                                        {
                                        value:  Number(if_undefined(capacity[steps_template[6].steps[1]])) + 
                                                Number(if_undefined(capacity[steps_template[6].steps[2]])) + 
                                                Number(if_undefined(capacity[steps_template[6].steps[3]])) + 
                                                Number(if_undefined(capacity[steps_template[6].steps[4]])) + 
                                                Number(if_undefined(capacity[steps_template[6].steps[5]])) + 
                                                Number(if_undefined(capacity[steps_template[6].steps[6]])) + 
                                                Number(if_undefined(capacity[steps_template[6].steps[7]])) + 
                                                Number(if_undefined(capacity[steps_template[6].steps[8]])),
                                        }
                                    ]
                                    }
                                ]
            ...
            <div id = "navmenu">
                ...
                <nav>
                    <ul id = "dashboard_list">
                        ...
                        <li id = "production_option"    class = "dashboard_option activebtn"    onclick="location.href='../PRODUCTION SUBMENU/BASE_production_menu.php'"     >Production</li>
                ...
                <div id = "lastupdateholder">
                    ...
                    <button id = "reload_button" class = "dashboard_option_"><img src = "../../../RESOURCES/reload.png" width="100%" height="100%" onclick = "location.href='BASE_SUB_get_data.php'"></button> 
                </div>
            </div>
            ...
            <div id = "production_menu" class = "submenu">
                ...
                <div id = "topright" class = "white sector top right" style = "width:62%">
                    ...
                    <div class = "head">
                        ...
                        <button class = "green br_green wtext" onclick = "location.href='../../PRODUCTION/BASE_production_groups.php?production_group=stores'">Stores</button>
                    </div>
                </div>
                            ...
                            <div class = "radio_buttons">
                                <div class = "radio_buttons_tray dark_grey">
                                    <div class = "radio_buttons_inner_tray">
                                        <div class = "radio_button cap_vs_dem mediumplus inactive" id = "tfive_weeks" style = "width:32%">25 Weeks</div>
                                        <div class = "radio_breaker" style = "width:2%"></div>
                                        <div class = "radio_button cap_vs_dem mediumplus active" id = "one_year" style = "width:32%">1 Year</div>
                                        <div class = "radio_breaker" style = "width:2%"></div>
                                        <div class = "radio_button cap_vs_dem mediumplus inactive" id = "two_years" style = "width:32%">2 Years</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class = "white sector bottom middle" style = "width:21%">
                    <div class = "head">
                        <div style = "height:100%;">
                            ...
                            <div class = "radio_buttons">
                                <div class = "radio_buttons_tray dark_grey">
                                    <div class = "radio_buttons_inner_tray">
                                        <div class = "radio_button released_pos mediumplus active" id = "today" style = "width:46%">TD</div>
                                        <div class = "radio_breaker" style = "width:8%"></div>
                                        <div class = "radio_button released_pos mediumplus inactive" id = "yesterday" style = "width:46%">YD</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class = "content">
                        ...
                        <div id = "yesterday" class = "radio_btn_page released_pos table_cont fill no_scrollbar" style = display:none;>
                            <div class = "content_table_margin">    
                                <table class = "alt_rcolor medium rh_med fillw">
                                    <thead>
                                        <tr class = "dark_grey wtext sticky">
                ...
                <div class = "white sector bottom right" style = "width:21%">
                    <div class = "head">
                        <div style = "height:100%;">
                            ...
                            <div class = "radio_buttons">
                                <div class = "radio_buttons_tray dark_grey">
                                    <div class = "radio_buttons_inner_tray">
                                        <div class = "radio_button complete_pos mediumplus active" id = "today" style = "width:46%">TD</div>
                                        <div class = "radio_breaker" style = "width:8%"></div>
                                        <div class = "radio_button complete_pos mediumplus inactive" id = "yesterday" style = "width:46%">YD</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class = "content">
                        ...
                        <div id = "yesterday" class = "radio_btn_page complete_pos table_cont fill no_scrollbar" style = display:none;>
                            <div class = "content_table_margin">    
                                <table class = "alt_rcolor medium rh_med fillw">
                                    <thead>
                                        <tr class = "dark_grey wtext sticky">
