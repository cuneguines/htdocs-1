    ...
    <body id = "operator_hours_table">
        <div id = "background">
            <div id = "content">
                ...
                <td style="background-color:#CBCBCB; border-right:1px solid #454545;" class="day-mon"><?= $operator["Monday"] != NULL ? "<button id='mon'>".$operator["Monday"]."</button>" : ""?></td>
                <td style="background-color:#CBCBCB; border-right:1px solid #454545;" class="day-tue"><?= $operator["Tuesday"] != NULL ? "<button id='tue'>".$operator["Tuesday"]."</button>" : ""?></td>
                <td style="background-color:#CBCBCB; border-right:1px solid #454545;" class="day-wed"><?= $operator["Wednesday"] != NULL ? "<button id='wed'>".$operator["Wednesday"]."</button>" : ""?></td>
                <td style="background-color:#CBCBCB; border-right:1px solid #454545;" class="day-thu"><?= $operator["Thursday"] != NULL ? "<button id='thu'>".$operator["Thursday"]."</button>" : ""?></td>
                <td style="background-color:#CBCBCB; border-right:1px solid #454545;" class="day-fri"><?= $operator["Friday"] != NULL ? "<button id='fri'>".$operator["Friday"]."</button>" : ""?></td>
                <td style="background-color:#CBCBCB; border-right:2px solid #454545;" class="day-sat"><?= $operator["Saturday"] != NULL ? "<button id='sat'>".$operator["Saturday"]."</button>" : ""?></td>
                <td style="background-color:#ABABAB;"class="day-total"><?= ($week_total == 0 || $week_total != NULL) ? "<button id='tot'>".$week_total."</button>" : ""?></td>
