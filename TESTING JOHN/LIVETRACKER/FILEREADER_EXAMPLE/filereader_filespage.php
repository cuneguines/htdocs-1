<?php
    ...
    include '../../PHP LIBS/PHP FUNCTIONS/filereader_functions.php';
    ...
    elseif(isset($_GET['po'])){
        echo "<h1>DO NOT CLOSE WINDOW BEFORE CLICKING CLOSE ATTACHMENTS</h1>";
        get_attachments_purchase_order($_GET['po'],$dir_prefix);
        $pass = "locationhref='./filereader_filespage.php?DEL=".$_GET['po']."'";
        echo "<br><br>";
        echo "<form action='./filereader_filespage.php' method='get'><button name='DEL' style = 'height:100px; width:500px; font-size:5vh;' value='".$_GET['po']."'>CLOSE ATTACHMENTS</button></form>";
    }
