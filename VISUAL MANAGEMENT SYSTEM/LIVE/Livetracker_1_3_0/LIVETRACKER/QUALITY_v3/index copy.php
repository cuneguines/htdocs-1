...
?>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a id="product_button" href="index%20copy.php"><i class="fa fa-sitemap"></i> Non Conformance<span class="fa arrow"></span></a>
                    ...
                    <li>
                        <a id="services_button_cc" href = "#" /*onclick = "location.href='saveQA.php'"*/><i class="fa fa-users"></i> Customer complaints<span class="fa arrow"></span></a>
        ...
        <div id="page-wrapper" >
            ...
            <div id="page-inner_one"style=display:none;>
                            ...
                            <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <option value="mholton@kentstainless.com" selected>mholton@kentstainless.com</option>
                                        <option value="jdonaldson@serc.ac.uk" selected>jdonaldson@serc.ac.uk</option>
