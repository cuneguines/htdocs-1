    ...
    <body>
        <div id = "background">
            <div style = "width:30%; height:20%; position:relative; vertical-align:top; top:40%; left: 35%; background-color:#ff5c33;">
                <form style = "height:100%; margin:0;" action = "./pw_protected.php" method="post">
                    <p style = "font-family:sans-serif; color:white; font-size:30px; margin-bottom:30px;"><br>Enter Password :</p>
                    <input style = "font-size:30px; width:30%; height:30%;" type="text" name="user" placeholder = "user"></input>
                    <input style = "font-size:30px; width:30%; height:30%;" type="password" name="password" placeholder = "password"></input>
