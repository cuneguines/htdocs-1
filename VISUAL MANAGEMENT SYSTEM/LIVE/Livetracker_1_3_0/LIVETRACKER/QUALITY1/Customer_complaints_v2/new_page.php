...
?>
    <?php include './SQL_new_page.php'; ?>
    <?php
    $getResults = $conn->prepare($Quality_results_non_conformance_update);
    $getResults->execute();
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a id="product_button" ><i class="fa fa-sitemap"></i> New Page updated values<span class="fa arrow"></span></a>
        ...
        <div id="page-wrapper" >
            <div class="header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="non.php">NC Page</a></li>
                    ...
                    <div class="card-body" id="card_body1" style="box-shadow: 0px -5px 10px 0px rgba(0, 0, 0, 0.5);overflow-x:scroll;overflow-y:scroll;height:65vh; width:100%;">
                        ...
                        <table id="products" style="position: sticky;overflow-x:scroll;">
                            <thead style="position:sticky;top:0;z-index:+2">
                              ...
                              <th style="position: sticky;width:100px;left:100px;color:white">Form type</th>
                                    <th style="position: sticky;width:150px;left:200px;color:white">Owner</th>
                                    <th style="position: sticky;width:150px;left:200px;color:white">Required Action</th>
                                ...
                                <?php foreach ($quality_results_nc as $row) : ?>
                                    <tr>
                                        ...
                                        <td style="position: sticky;left:100px;px;background:#a6cbf7;text-align:center"><?= $row["form_type"]?></td>
                                        <td style="position: sticky;left:200px;background:#a6cbf7"><?= $row["Owner"] ? $row["Owner"]  : 'NULL' ?></td>
                                       
                                        <td style="text-align:center"><?=$row["Action"]? $row["Action"]:'NULL'?></td>
                                        <td style="text-align:center"><?=$row["Status"]?$row["Status"]:'NULL'?></td>
                                        <td style="text-align:center"><?=$row["date_updated"]?$row["date_updated"]:'NULL'?></td>
