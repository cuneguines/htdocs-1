        ...
        <nav class="navbar-default navbar-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a id="product_button"><i class="fa fa-sitemap"></i> Customer Complaints<span class="fa arrow"></span></a>
                        ...
                        <table id="products" style="position: sticky;overflow-x:scroll;">
                            ...
                            <?php foreach ($quality_results_nc as $row) : ?>
                                ...
                                <tr>
                                    ...
                                    <td style="position: sticky;left:100px;px;background:linear-gradient(100deg,#2196f3, white );text-align:center"><?= $row["cc_itemcode"] ?></td>
                                    <td class="bold" style="position: sticky;left:200px;background:linear-gradient(100deg,#2196f3, white )"><?= $row["cc_desc"] ? $row["cc_desc"]  : '--------' ?></td>


                                    <td style="text-align:center"><?= $row["cc_sales_order"] ?></td>
                                    <td style="text-align:center"><?= $row["cc_process_order"] ?></td>
