...
<h2 style="margin-left:5%">Days left Per Person from Most urgent to least urgent </h2>
    <canvas  id="urgencyChart" ></canvas>
    </div>
<body>

    <script>
        // PHP variable with data from SQL
        <?php
            ...
            $sql = "SELECT Person[Name], MAX(Days_Open)[Least Urgent Action], MIN(Days_Open)[Most Urgent Action], COUNT(Days_OPEN)[No Of Actions]
            ...
            foreach ($result as $row) {
                $data[] = [
                    'name' => $row['Name'],
                    'leastUrgent' => $row['Least Urgent Action'],
                    'mostUrgent' => $row['Most Urgent Action']
                ];
            }
            ...
            datasets: [
                {
                    ...
                    data: <?php echo json_encode(array_column($data, 'leastUrgent')); ?>,
                ...
                },
                {
                    ...
                    data: <?php echo json_encode(array_column($data, 'mostUrgent')); ?>,
