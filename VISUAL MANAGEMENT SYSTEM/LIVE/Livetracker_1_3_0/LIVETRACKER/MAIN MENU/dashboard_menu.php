				...
				<div class = 'background_mask' style = "width:40%; height:100%; float:left;">
					...
					<div style = "width:100%; height:65%; position:relative; vertical-align:top;">
						<div class = "page_buttons" style = "width:95%; margin-left:2.5%; margin-right:2.5%; position:relative; height:95%; top:2.5%; background-color:#454545; border-radius:20px; border:3px solid green;">
							...
							<button class = "orange production" style = "width:30%; height:10%; margin-left:1%; font-size:2.5vh; position:relative; top:0%; margin-top:2%;" onclick="location.href='../PRODUCTION/SCHEDULE/production_project_manager/BASE_project_manager_schedule.php'">Proj/Eng Schedule</button>
							...
							<button id='test'class = "green production hr" style = "width:30%; height:10%; margin-left:1%; font-size:2.5vh; position:relative; top:0%; margin-top:2%;" onclick="window.location.href='http://127.0.0.1:3000';">TEST</button>
