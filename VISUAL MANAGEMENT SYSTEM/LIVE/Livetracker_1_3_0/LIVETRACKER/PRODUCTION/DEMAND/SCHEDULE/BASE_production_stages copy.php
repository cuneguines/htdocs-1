...
<html>
    <head>
        ...
        <?php include 'SQL_production_stages.php'; ?>
        <?php
...
<?php $so = "location.href='http://vms/SAP%20READER/BASE_sales_order.php?sales_order=".$row["Sales Order"]."'" ?>
                                ...
                                <tr sales_person = <?= $sales_person ?> engineer = <?= $engineer ?> project = <?= $project ?> customer = <?= $customer ?>>
                                    ...
                                    <?php foreach($group_steps_template as $group): ?>
                                        <?php foreach($group["steps"] as $step):?>
                                            ...
                                            <td step_laser=<?= $step.$step_status ?> class = "<?=$group["name"]?>" style = "background-color:<?=$group['color']?>" onclick = "alert('<?=$booked_hrs_line_details?>')"><div class = "progress_bar_container <?= !$step_exists ? 'opaque' : '' ?>"><div class = "progress_bar <?=$fill_level_color?>" style = "width:<?=$width?>px; position:absolute;"></div><div style = "width:100%; height:100%; position:absolute;"><?=$step_status?></div></td>
                                        <?php endforeach;?>
                                    <?php endforeach; ?>  
                                </tr>
                            <?php endforeach; ?>
      ...
      <td class = "sticky material_prep fabrication_1 fabrication_2 finishing docs_and_deliverables stores" style = "left:0px;"></td>
      <td class = "sticky material_prep fabrication_1 fabrication_2 finishing docs_and_deliverables stores" style = "left:80px;"></td>
      <td class = "sticky material_prep fabrication_1 fabrication_2 finishing docs_and_deliverables stores" style = "left:160px;"></td>
      <td class = "sticky material_prep fabrication_1 fabrication_2 finishing docs_and_deliverables stores" style = "left:260px;"></td>
      <td class = "sticky material_prep fabrication_1 fabrication_2 finishing docs_and_deliverables stores" style = "left:460px;"></td>
      <td class = "sticky material_prep fabrication_1 fabrication_2 finishing docs_and_deliverables stores" style = "left:460px;"></td>
      <td class = "sticky material_prep fabrication_1 fabrication_2 finishing docs_and_deliverables stores" style = "left:460px;"> </td>
      <td class="material_prep"><button value="[step_laser=SEQ001"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>
      <td class="material_prep"><button value="[step_laser=SEQ002"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>
      <td class="material_prep"><button value="[step_laser=SEQ003"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>
      <td class="material_prep"><button value="[step_laser=SEQ004"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>
      <td class="material_prep"><button value="[step_laser=SEQ005"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>
      <td class="material_prep"><button value="[step_laser=SEQ006"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>
      <td class="material_prep"><button value="[step_laser=SEQ007"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>
      <td class="material_prep"><button value="[step_laser=SEQ008"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>
      
      <td class="fabrication_1"><button value="[step_laser=SEQ010"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>
      <td class="fabrication_1"><button value="[step_laser=SEQ010A"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>
      <td class="fabrication_1"><button value="[step_laser=SEQ010B"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>
      <td class="fabrication_1"><button value="[step_laser=SEQ010C"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>
      <td class="fabrication_1"><button value="[step_laser=SEQ010D"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>
      <td class="fabrication_1"><button value="[step_laser=SEQ010E"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>
      <td class="fabrication_1"><button value="[step_laser=SEQ011"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>
      <td class="fabrication_1"><button value="[step_laser=SEQ013"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>

      <td class="fabrication_2"><button value="[step_laser=SEQ012"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>
      <td class="fabrication_2"><button value="[step_laser=SEQ014"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>
      <td class="fabrication_2"><button value="[step_laser=SEQ015"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>
      <td class="fabrication_2"><button value="[step_laser=SEQ016"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>
      <td class="fabrication_2"><button value="[step_laser=SEQ017"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>
      <td class="fabrication_2"><button value="[step_laser=SEQ018"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>
      
      <td class="finishing"><button value="[step_laser=SEQ020"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>
      <td class="finishing"><button value="[step_laser=SEQ021"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>
      <td class="finishing"><button value="[step_laser=SEQ022"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>
      <td class="finishing"><button value="[step_laser=SEQ023"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>
      <td class="finishing"><button value="[step_laser=SEQ024"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>
      <td class="finishing"><button value="[step_laser=SEQ025"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>
      <td class="finishing"><button value="[step_laser=SEQ026"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>
     
      <td class="docs_and_deliverables"><button value="[step_laser=SEQ027"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>
      <td class="docs_and_deliverables"><button value="[step_laser=SEQ028"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>
      <td class="docs_and_deliverables"><button value="[step_laser=SEQ029"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>

      <td class="stores"><button value="[step_laser=SEQ009"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>
      <td class="stores"><button value="[step_laser=SEQ019"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>
      <td class="stores"><button value="[step_laser=SEQ030"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>
      <td class="stores"><button value="[step_laser=SEQ031"class="button_group fill red medium wtext" style="font-size: 1.2vh;border-radius:50%;margin-left:25%;width:75%;height:40%;float:left">Hide</button>
                        ...
                        <div id = "filter_container">
                            <div id = "filters" class = "red fill rounded">
                                ...
                                <div class = "filter">
                                   ...
                                   <button class="fill bblue medium wtext" style="font-size:1.6vh;float:left;position: relative;width:19%;background-color:blue;margin-left:-19%;
