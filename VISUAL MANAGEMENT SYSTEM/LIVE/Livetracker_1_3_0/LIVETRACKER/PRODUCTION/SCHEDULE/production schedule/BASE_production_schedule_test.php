                                ...
                                <?php for($i = 0 ; $i <= sizeof($results) ; $i++):?>
                                    <?php
                                        ...
                                        if(($results[$i]["Project"] != $active_project && $first == 0) || $i == sizeof($results)){
                                            ...
                                            $products_str = implode(" ",$project_products_buffer);
   
                                            // PRINT BREAKDOWN ROW WITH BUTTONS FROM BUFFER OF ACTIVE PROJECT
                                            echo "<tr class = 'row white smedium' product = '".$products_str."'customer = '".$customer."' project = '".$project."' engineers = '".$engineers_str."' sales_person = '".$sales_person."' promise_week_due = '".$promise_week_due."' type =  breakdown>";
                                            ...
                                            echo "<tr class = 'row smedium' style = 'background-color:#DCDCDC;' type = 'data' customer = '".$customer."' product = '".$products_str."'engineers = '".$engineers_str."' project = '".$project."' sales_person = '".$sales_person."'><td style = 'background-color:#454545;color:white;'>".$project_unp."</td>";
                                        ...
                                        if($results[$i]["Project"] != $active_project || $first == 1){
                                            ...
                                            $product = str_replace(' ','',preg_replace("/[^A-Za-z0-9 ]/", '', $results[$i]["Product Group"]));
                                        ...
                                        $str = generate_schedule_buttons($base_color,
                                            $border_color,
                                            $overwrite,
                                        ...
                                        if(!in_array(str_replace(' ','',preg_replace("/[^A-Za-z0-9 ]/", '', $results[$i]["Product Group"])), $project_products_buffer))
                                        {
                                            array_push($project_products_buffer, str_replace(' ','',preg_replace("/[^A-Za-z0-9 ]/", '', $results[$i]["Product Group"])));
                                        }
                            ...
                            <div id = "filter_container">
                                <div id = "filters" class = "red fill rounded">
                                    ...
                                    <div class = "filter">
                                        ...
                                        <div class = "content">
                                            <select id = "select_product" class = "selector fill medium">
                                                <option value = "All" selected>All</option>
