$(document).ready(function () {
    ...
    $("h2.thirteenth").replaceWith( '<h2 class = "inner thirteenth medium"><button class = "brred rounded btext white medium" style = "height:30px; width:150px;" onclick = "location.href='+ "'" +'/../SAP READER/BASE_process_order.php?process_order='+ $(this).attr('process_order') + "'" + '">'+ $(this).attr('process_order') +"</button></h2>");
        //$("h2.thirteenth").replaceWith('<h2 class = "inner thirteenth medium"><button class = "brred rounded btext white medium" style = "height:30px; width:150px;" onclick = "location.href=' + "'" + '/../SAP READER/SAP READER/Base_process_order.php?process_order=' + $(this).attr('process_order') + ",NORMAL'" + '">' + $(this).attr('process_order') + "</button></h2>");
