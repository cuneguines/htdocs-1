   ...
   /*  function generate_filter_optionss($table, $field)
    {
        foreach (array_sort(array_unique(array_column($table, $field))) as $element) {
            ...
            if (date("w") == 1) {
                if ($element == 'Monday' || $element == 'Tuesday' || $element == 'Wednesday' || $element == 'Thursday' || $element == 'Friday' || $element == 'Other' || $element == 'Last Working Day') {
                    echo "<option value = '" . str_replace(' ', '', preg_replace("/[^A-Za-z0-9 ]/", '', $element)) . "'>" . ($element) . "</option>";
                }
            } else
                if ($element == 'Monday' || $element == 'Tuesday' || $element == 'Wednesday' || $element == 'Thursday' || $element == 'Friday' || $element == 'Other') {
                echo "<option value = '" . str_replace(' ', '', preg_replace("/[^A-Za-z0-9 ]/", '', $element)) . "'>" . ($element) . "</option>";
            }
        }
    } */
                    ...
                    <table id="production_schedule" class="filterable">
                        <thead>
                            <tr class="dark_grey wtext smedium">
                                ...
                                <th style='width:3.64%;'>Week -2</th>
                                <th style='width:3.64%;'>Week -1</th>
