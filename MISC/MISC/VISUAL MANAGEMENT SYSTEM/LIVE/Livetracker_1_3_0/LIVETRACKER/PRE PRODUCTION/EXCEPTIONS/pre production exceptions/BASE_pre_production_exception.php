                    ...
                    <table id = "pre_production_exceptions" class = "tablesorter filterable">
                        ...
                        <?php
                            foreach($pre_production_exceptions_results  as $row): ?>
                                ...
                                <?php   $salesperson = str_replace(' ','',preg_replace("/[^A-Za-z0-9 ]/", '', $row["Sales Person"])); ?>
                                ...
                                <tr class = 'white btext' salesperson = '<?=$salesperson?>' stage = '<?=$stage?>' project = '<?=$project?>' engineer = '<?=$engineer?>'comments = '".$row["Comments"]."' <?=$row_color?>>
