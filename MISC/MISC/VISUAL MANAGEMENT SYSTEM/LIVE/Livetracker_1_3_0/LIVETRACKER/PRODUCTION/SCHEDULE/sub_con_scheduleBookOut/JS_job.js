...
console.log(data[0]);
   ...
   // $("h2.first").replaceWith( "<h2 class = 'inner first medium'>"+$(this).attr('sales_order')+"</h2>");
    ...
    $("h2.twentyone").replaceWith( "<h2 class = 'inner twentyone medium'>"+$(this).attr('weeks_on_floor')+"</h2>");
    $("h2.eleventh").replaceWith( "<h2 class = 'inner eleventh medium'>"+$(this).attr('comments')+"</h2>");
    $("h2.twenty").replaceWith( "<h2 class = 'inner twenty small'>"+$(this).attr('comments_2')+"</h2>");
