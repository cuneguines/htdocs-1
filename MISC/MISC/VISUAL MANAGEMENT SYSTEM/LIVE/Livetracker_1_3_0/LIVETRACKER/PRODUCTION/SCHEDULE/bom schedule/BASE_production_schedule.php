...
<html>
    <head>
        ...
        ?>
        <?php
            if(isset($_GET['sheet_bar_box_only'])){
                $clause = "AND (t4.ItmsGrpNam LIKE '%Sheet%' OR t4.ItmsGrpNam LIKE '%Bar%' OR t4.ItmsGrpNam LIKE '%Box%')";
                $title = "BOM SCHEDULE ONLY SHEET BAR BOX";
                $type = "OBAR";
            }
            if(isset($_GET['without_sheet_bar_box'])){
                $clause = "AND t4.ItmsGrpNam NOT LIKE '%Sheet%' AND t4.ItmsGrpNam NOT LIKE '%Bar%' AND t4.ItmsGrpNam NOT LIKE '%Box%'";
                $title = "BOM SCHEDULE WIHTOUT SHEET BAR BOX";
                $type = "NBAR";
            }
        ?>
