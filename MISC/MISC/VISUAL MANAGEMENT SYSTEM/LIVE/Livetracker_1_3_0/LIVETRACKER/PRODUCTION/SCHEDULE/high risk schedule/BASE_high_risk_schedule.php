...
<html>
    <head>
        ...
        <title>HIGH RISK SCHEDULE</title>
        ...
        <script type = "text/javascript" src = "./JS_daterange_buttons.js"></script>
        ...
        <?php include './SQL_high_risk_schedule.php'; ?>
            ...
            <div id = "content">
             ...
             --><div id = "sched_right">
                        ...
                        <table id = "high_risk_schedule" class = "filterable">
                            ...
                            <tbody class = "smedium btext">
                                ...
                                <?php for($i = 0 ; $i <sizeof($results) ; $i++): ?>
                                    <?php
                                        // IF ON LAST ROW SKIP INTO PRINT LAST ROW, OTHERWISE ENTER NORMALLY IF PROJECT ON CURRENT ROW DOES NOT MATCH THE CURRENT ACTIVE PROJECT  AND WE ARE NOT ON FIRST ROW OF QUERY
                                        if($i == sizeof($results)){goto printrow;}
                                        if(($results[$i]["Project"] != $active_project && $first == 0) || $i == sizeof($results)-1){
                                            printrow:
                                        ...
                                        // BORDER COLOR
                                        if($results[$i]["Sub Contract Status"] == 'Yes' || $results[$i]["Sub Contract Status"] == '1002'){
                    ...
                    <div class = "ledgend btext medium">
                        ...
                        --><div class = "subdividor light_grey">
                                <div class = "half">
                                    <div class = "textholder"><p>Notifications</p></div><div class = "button_holder"><button class = "greenshadow"></button></div>
                                </div>
                                <div class = "half">
                    ...
                    <div id = "schedule_pages_footer" class = "footer">
                        ...
                        <div id = "bottom">                        
                            <div id = "button_container_sched_left">
                                <button id = "712" class = "hr_days grouping_page_corner_buttons fill medium red wtext rounded-left" style = "float:left; width:20%">RESET</button>
                                <button id = "2" class = "hr_days grouping_page_corner_buttons fill medium red wtext" style = "float:left; width:20%">2 DAYS</button>
                                <button id = "4" class = "hr_days grouping_page_corner_buttons fill medium red wtext" style = "float:left; width:20%">4 DAYS</button>
                                <button id = "7" class = "hr_days grouping_page_corner_buttons fill medium red wtext" style = "float:left; width:20%">7 DAYS</button>
                                <button id = "14" class = "hr_days grouping_page_corner_buttons fill medium red wtext rounded-right" style = "float:left; width:20%">14 DAYS</button>
                            </div>
                            ...
                            <div id = "button_container_sched_flip_flop">
                                <button onclick = "location.href='../../../PRODUCTION/SCHEDULE/PRODUCTION SCHEDULE/BASE_production_schedule.php'" class = "grouping_page_corner_buttons fill medium purple wtext rounded-left" style = "float:left; width:50%">PROD</button>
                            ...
                            <div id = "button_container_sched_btn">
                                <button onclick = "export_to_excel('high_risk_schedule')" class = "grouping_page_corner_buttons fill medium green wtext rounded" style = "float:left; width:100%">EXCEL</button>
                            </div>
                            <div id = "button_container_sched_btn">
