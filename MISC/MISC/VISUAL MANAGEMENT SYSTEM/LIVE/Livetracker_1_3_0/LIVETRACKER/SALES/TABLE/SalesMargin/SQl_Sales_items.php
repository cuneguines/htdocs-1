<?php
$sales_order_items="with sales_orders as (--- Sales Order Details -----
                     ...
                     FORMAT(CAST(isnull(t0.U_delivery_date, t1.DocDueDate) AS DATE),'dd-MM-yyyy') [Due_Date],
...
and [Sales Order] LIKE $sales_order
