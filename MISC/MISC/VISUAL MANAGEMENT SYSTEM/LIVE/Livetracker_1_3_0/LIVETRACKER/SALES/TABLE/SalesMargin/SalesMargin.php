                ...
                <table id="new_sales_orders_margin" class="filterable sortable colborders">
                    <thead>
                        ...
                        <tr class="dark_grey wtext smedium head">
                            ...
                            <th width="8%">Earliest Due Date</th>
                            <th width="7%">Sales Value</th>
                            <th width="7%">SO_Original_Cost</th>
                            <th width="8%">Planned_BOM_Cost</th>
                            <th width="8%">Planned Prod Order Cost</th>
                            <th width="7%">Likely Prod Ord Cost</th>
                            <th width="7%">Orig Margin</th>
                            <th width="7%">Planned BOM Margin</th>
                            
                            <th width="7%">Planned Prod Ord Margin</th>
                            <th width="7%">Likely Prod Ord Margin</th>
                            <!-- <th width="4%">Comm</th> -->
                        </tr>
                    </thead>
                    <tbody class="white">
                        <?php foreach ($sales_margin_results as $sales_order) : ?>
                            ...
                            <td><button class = "brred rounded btext medium" onclick = "location.href='./BASE_sales_order_items.php?so=<?=$sales_order['Sales Order']?>'"><?= $sales_order["Sales Order"]?><button></td>
                                
                                <td class='lefttext bold'><?= $sales_order["CardName"] ?></td>
                                <td class = 'lefttext'><?= $sales_order["U_Client"] ?></td>
                                <td><?= $sales_order["Earliest Due Date"]?></td>
                                <td class = "righttext"><?= round($sales_order["Sales Value"],0) ?></td>
                                <td class = "righttext"><?= round($sales_order["SO_Original_Cost"],0) ?></td>
                                <td class = "righttext"><?=round ($sales_order["Planned_BOM_Cost"],0 )?></td>
                                
                                <td class = "righttext">€<?= round($sales_order["Planned Prod Order Cost"],0)?></td>
                                <td class = "righttext"><?= round($sales_order["Likely Prod Ord Cost"] ,0)?></td>
