...
<body>
  <div id="background" style="float: left; width: 50%;">
    <div id="content">
      <div style="height:40%;margin-top:6%;background-color: PINK;box-shadow: -3px 3px 6px #03A9F4, 0 1px 4px #03A9F4;">
  ...
  <div id="background">
    <div id="content">
      <div style="height:85%;margin-top:6%;background-color: lightblue;box-shadow: -3px 3px 6px #03A9F4, 0 1px 4px #03A9F4;">
